...
const SomeParagraf = () => {
  ...
  const toggleFour=()=>{
    ...
    return ( 
        ...
        <button onClick={toggleOne}  className="buttonToggleAll">{stateOne?<FontAwesomeIcon onClick={()=>setOpenmyDomainsOne(!OpenmyDomainsOne)}   className="icone" icon={faAngleUp}/>:<FontAwesomeIcon onClick={()=>setOpenmyDomainsOne(!OpenmyDomainsOne)}   className="icone" icon={faAngleRight}/>}</button>
        </div>
     ...
     <div className='TogglePossibleSome'>
        ...
        <div className="space"></div>
        <button onClick={toggleTwo}  className="buttonToggleAll">{stateTwo?<FontAwesomeIcon onClick={()=>setOpenmyDomainsTwo(!OpenmyDomainsTwo)}   className="icone" icon={faAngleUp}/>:<FontAwesomeIcon onClick={()=>setOpenmyDomainsTwo(!OpenmyDomainsTwo)}   className="icone" icon={faAngleRight}/>}</button>
        </div>
     ...
     <div className='TogglePossibleSome'>
        ...
        <div className="space"></div>
        <button onClick={toggleThree}  className="buttonToggleAll">{stateThree?<FontAwesomeIcon onClick={()=>setOpenmyDomainsThree(!OpenmyDomainsThree)}   className="icone" icon={faAngleUp}/>:<FontAwesomeIcon onClick={()=>setOpenmyDomainsThree(!OpenmyDomainsThree)}   className="icone" icon={faAngleRight}/>}</button>
        </div>
     ...
     <div className='TogglePossibleSome'>
        ...
        <div className="space"></div>
        <button onClick={toggleFour}  className="buttonToggleAll">{stateFour?<FontAwesomeIcon onClick={()=>setOpenmyDomainsFour(!OpenmyDomainsFour)}   className="icone" icon={faAngleUp}/>:<FontAwesomeIcon onClick={()=>setOpenmyDomainsFour(!OpenmyDomainsFour)}   className="icone" icon={faAngleRight}/>}</button>
        </div>
