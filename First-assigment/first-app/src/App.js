...
const list=[
  ...
  {
  //  image:"https://www.verisign.com/en_US/resources/img/VRSN_SocialShare-com-Logo_201712.png",
    imageTwo:"https://icon-library.com/images/recognition-icon/recognition-icon-11.jpg",
    // image:{image1},
    TitleTwo:"International recognition",
    paragrafTwo:"Can the domain name be used on an international sole  "

  },
  {
    imageTwo:"https://cdn4.vectorstock.com/i/1000x1000/16/98/search-tools-icon-vector-6201698.jpg",
    // image:"https://www.verisign.com/en_US/resources/img/VRSN_SocialShare-com-Logo_201712.png",
    TitleTwo:"Search engine",
    paragrafTwo:"Does the doain follow search ergine gudilens"

  },
  {
    imageTwo:"https://wearedapa.co.uk/wp-content/uploads/2017/06/outreach-icon.jpg",
    // image:"https://www.verisign.com/en_US/resources/img/VRSN_SocialShare-com-Logo_201712.png",
    TitleTwo:"Advertsing Potential",
    paragrafTwo:"Could the domain be used for advertsing campsignes "

  },
  {
    imageThree:"https://cdn4.vectorstock.com/i/1000x1000/77/58/costs-optimization-efficiency-icon-vector-23097758.jpg",
    // image:"https://www.verisign.com/en_US/resources/img/VRSN_SocialShare-com-Logo_201712.png",
    TitleThree:"Sales",
    paragrafThree:"Can the domain name be used on an inertational scale "

  },
  {
    imageThree:"https://www.shareicon.net/data/512x512/2016/10/20/846415_blue_512x512.png",
    // image:"https://www.verisign.com/en_US/resources/img/VRSN_SocialShare-com-Logo_201712.png",
    TitleThree:"Typo susceptiility",
    paragrafThree:"How hight is the risk of mistyping the domain name  "

  },
  {
    // image:"https://www.verisign.com/en_US/resources/img/VRSN_SocialShare-com-Logo_201712.png",
    imageThree:"https://img.favpng.com/2/14/25/skill-icon-boosting-potential-icon-business-motivation-icon-HydUTqU5.jpg",
    TitleThree:"Business Potential",
    paragrafThree:"Can the domin be used as your company "
  ...
  return (
    <div className="App">
      ...
      {list.map((lis)=>(
            ...
            <div>
                  <img src={lis.imageTwo}/>
                  
                  
                  <strong>{lis.TitleTwo}</strong>
                  <p>{lis.paragrafTwo} </p>
                  
    
            </div>
            <div>
                  <img src={lis.imageThree}/>
                  
                  
                  <strong>{lis.TitleThree}</strong>
                  <p>{lis.paragrafThree} </p>
